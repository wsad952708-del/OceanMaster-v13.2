/**
 * OceanMaster v12 — Dashboard v2 JavaScript  [v12-phase8]
 * ========================================================
 * 功能:
 *   1. Leaflet 全螢幕地圖 + 熱力圖
 *   2. 熱點標記 + 左側邊欄列表
    ...
    function renderHotspotMarkers(hs) {
        ...
        hs.slice(0, 20).forEach((h, i) => {
            ...
            const icon = L.divIcon({
                className: '',
                html: `<div class="hotspot-marker ${isTop3 ? 'top3' : ''}">${i + 1}</div>`,
            ...
            marker.bindPopup(`
            <div style="font-family:Inter,'Noto Sans TC',sans-serif;font-size:13px;">
                <strong>#${i + 1} ${SPECIES_ZH[h.species] || ''}</strong><br>
                HSI: ${pct}% | SST: ${h.sst ? h.sst.toFixed(1) + '°C' : '--'}<br>
