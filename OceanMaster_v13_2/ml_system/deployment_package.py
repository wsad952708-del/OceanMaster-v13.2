...
def create_app(model_dir: str = "ml_system/models") -> "FastAPI":
    ...
    # [audit-fix] CORS — env var controlled, default restricted to localhost
...
def generate_dockerfile(output_dir: str = "."):
    ...
    # [v13.2-R4-P3] Note: pin digest in production builds
    dockerfile = """# ⚠️ Pin base image digest before production: docker pull python:3.11-slim && docker inspect --format='{{index .RepoDigests 0}}' python:3.11-slim
