"""
OceanMaster v13.2 — GeoJSON 輸出 + 衛星 Email 傳送
====================================================
🟡 補充功能
    ...
    for h in hotspots:
        feature = {
            ...
            "properties": {
                ...
                "raw_hsi": round(h.get("raw_hsi", h.get("score", 0)), 4),
                "score_display": h.get("score_display", round(h.get("score", 0), 2)),
