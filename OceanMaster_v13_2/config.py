"""
OceanMaster v13.2 — 全域設定  # [v13-dual-scale]
==============================
...
v13 新增: 雙模式 (近海/遠洋) 預設、台灣近海魚種、黑潮引擎
"""
...
# ═══════════════════════════════════════════════════════
# [v13] 雙模式 (Dual-Scale) 作業預設
# ═══════════════════════════════════════════════════════
KAOHSIUNG_PORT = (22.61, 120.28)  # 高雄港 (前鎮漁港)
...
OPERATION_PRESETS = {
    "nearshore": {
        ...
        "lat_range": (20, 27),
        "lon_range": (118, 125),
        "resolution": 0.10,           # 近海需要更高解析度
        "vessel_pos": KAOHSIUNG_PORT,
        "species": [
            "yellowfin", "bigeye", "skipjack", "albacore",
            "mahi_mahi", "blue_marlin", "mackerel_scad",
        ],
        "kuroshio_mode": True,
        "description": "台灣海峽+巴士海峽+東部外海 (黑潮核心區域)",
    },
    "offshore": {
        "name": "西太平洋遠洋模式",
        "lat_range": (5, 35),
        ...
        "kuroshio_mode": False,
        "description": "WCPFC 管轄區域全覆蓋 (中西太平洋)",
    },
}

ERDDAP_SOURCES = {
    "sst_oisst": {
        "url": "https://coastwatch.noaa.gov/erddap/griddap/ncdcOisst21Agg",
    ...
    "chlorophyll": {
        "url": "https://coastwatch.noaa.gov/erddap/griddap/erdMH1chla1day",
        "var": "chlorophyll", "desc": "MODIS Aqua Chl-a (4km, 每日)",
    },
    "wind_u": {
        "url": "https://coastwatch.noaa.gov/erddap/griddap/erdQMwindmday",
        "var": "x_wind", "desc": "QuikSCAT 月均風 U",
    },
    "etopo1": {
        "url": "https://coastwatch.noaa.gov/erddap/griddap/etopo180",
...
_HSI_OVERRIDES = {
    ...
    "squid_todarodes": {
        ...
        "sst_optimal": 15.0, "sst_sigma": 3.0, "sst_range": (8.0, 22.0),
        "chl_optimal": 0.5, "chl_sigma": 0.5, "chl_range": (0.2, 5.0),
        "depth_range": (0, 400), "do_min": 2.0, "do_preferred": 3.0,
        "moon_sensitivity": 0.9, "viirs_weight": 1.0,
        "forage_layer": "epipelagic",
    },
    "japanese_flying_squid": {
        "name_zh": "日本魷", "name_en": "Japanese Flying Squid",
        "sst_optimal": 15.0, "sst_sigma": 3.0, "sst_range": (8.0, 22.0),
        "chl_optimal": 0.5, "chl_sigma": 0.5, "chl_range": (0.2, 5.0),
        "depth_range": (0, 400), "do_min": 2.0, "do_preferred": 3.0,
        "moon_sensitivity": 0.9, "viirs_weight": 1.0,
    ...
    # [v13.2-fix] squid_ommastrephes → neon_flying_squid 的別名（參數在 _build_species_params 中自動合併）
    # [v13.2-fix] squid_todarodes → japanese_flying_squid 的別名
    # 不再重複定義，統一由 _build_species_params() 號理別名對應
    # ── v13 台灣近海/遠洋新增 ──
    "mahi_mahi": {
        "name_zh": "鬼頭刀", "name_en": "Mahi-mahi",
        "sst_optimal": 27.0, "sst_sigma": 3.0, "sst_range": (21.0, 33.0),
        "chl_optimal": 0.3, "chl_sigma": 0.2, "chl_range": (0.1, 0.8),
        "ssh_range": (-0.05, 0.20), "depth_range": (0, 85),
        "do_min": 3.0, "do_preferred": 4.5,
        "salinity_range": (33.5, 36.0), "salinity_optimal": 35.0,
        "front_attraction": 0.9, "ftle_weight": 0.7,
        "moon_sensitivity": 0.2, "forage_layer": "epipelagic",
        "kuroshio_boost": 0.9,  # [UNVALIDATED] 黑潮邊緣極高聚集
    },
    "blue_marlin": {
        "name_zh": "旗魚", "name_en": "Blue Marlin",
        "sst_optimal": 26.0, "sst_sigma": 3.5, "sst_range": (20.0, 31.0),
        "chl_optimal": 0.2, "chl_sigma": 0.15, "chl_range": (0.05, 0.5),
        "ssh_range": (-0.10, 0.15), "depth_range": (0, 800),
        "do_min": 2.5, "do_preferred": 4.0,
        "salinity_range": (34.0, 36.5), "salinity_optimal": 35.0,
        "thermocline_importance": 0.9, "forage_layer": "mixed",
        "kuroshio_boost": 0.85,
    },
    "mackerel_scad": {
        "name_zh": "竹筴魚", "name_en": "Mackerel Scad",
        "sst_optimal": 24.0, "sst_sigma": 4.0, "sst_range": (16.0, 30.0),
        "chl_optimal": 0.8, "chl_sigma": 0.5, "chl_range": (0.2, 3.0),
        "ssh_range": (-0.10, 0.10), "depth_range": (0, 200),
        "do_min": 3.0, "do_preferred": 4.0,
        "salinity_range": (33.0, 35.5), "salinity_optimal": 34.0,
        "front_attraction": 0.6, "ftle_weight": 0.4,
        "moon_sensitivity": 0.3, "forage_layer": "epipelagic",
        "kuroshio_boost": 0.55,
    },
    "pacific_saury": {
        "name_zh": "秋刀魚", "name_en": "Pacific Saury",
        "sst_optimal": 15.0, "sst_sigma": 3.0, "sst_range": (8.0, 22.0),
        "chl_optimal": 0.5, "chl_sigma": 0.5, "chl_range": (0.2, 5.0),
        "depth_range": (0, 150), "do_min": 3.0, "do_preferred": 4.5,
        "moon_sensitivity": 0.7, "viirs_weight": 0.8,
        "forage_layer": "epipelagic",
        "kuroshio_boost": 0.4,
    },
}
    ...
    try:
        ...
        for key, hsi in _HSI_OVERRIDES.items():
            if key not in merged:
                merged[key] = dict(hsi)
        # [v13.2-fix] M-1 別名對應 — 若主名存在則別名自動繼承
        _ALIASES = {
            "squid_ommastrephes": "neon_flying_squid",
            "squid_todarodes": "japanese_flying_squid",
        }
        for alias, canonical in _ALIASES.items():
            if canonical in merged and alias not in merged:
                merged[alias] = dict(merged[canonical])
        return merged
    except ImportError:
...
# [v13.2-fix] M-6: CPUE 正規化參數集中管理
# Source: WCPFC Statistical Yearbook median CPUE (kg/day, longline)
CPUE_NORMALIZATION = {
    "yellowfin":    {"median": 45, "scale": 20},
    "bigeye":       {"median": 35, "scale": 12},
    "skipjack":     {"median": 100, "scale": 35},
    "albacore":     {"median": 32, "scale": 10},
    "mahi_mahi":    {"median": 30, "scale": 15},
    "blue_marlin":  {"median": 25, "scale": 10},
    "mackerel_scad":{"median": 80, "scale": 30},
    "pacific_saury":{"median": 60, "scale": 25},
}

# [v13.2-fix] M-4: 溫躍層計算用標準深度陣列 (統一來源)
STANDARD_DEPTH_LEVELS = [0, 10, 20, 30, 50, 75, 100, 125, 150, 200, 250, 300, 400, 500]
HYCOM_SUBSET_DEPTHS = [0, 50, 100, 200, 300, 500]  # 簡化版 (快速運行)
