"""
OceanMaster v13.2 — Feature Builder
=====================================
...
class FeatureMatrix:
    ...
    # [海鷹/蒼鷺] 深層特徵
    t100: np.ndarray = None               # 100m 水溫
    gradient_strength: np.ndarray = None   # ΔT/ΔZ 梯度
    gradient_depth: np.ndarray = None      # 最大梯度深度
    delta_t_surface_100: np.ndarray = None # SST - T100
    chl_lag15d: np.ndarray = None          # 15 天前 CHL
